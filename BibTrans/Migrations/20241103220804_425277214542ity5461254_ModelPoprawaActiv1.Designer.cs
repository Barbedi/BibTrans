...
namespace BibTrans.Migrations
{
    ...
    [Migration("20241103220804_425277214542ity5461254_ModelPoprawaActiv1")]
    partial class _425277214542ity5461254_ModelPoprawaActiv1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BibTrans.Areas.Identity.Data.BibTransUser", b =>
                {
            ...
            modelBuilder.Entity("BibTrans.Models.Borrowing", b =>
                {
                    b.HasOne("BibTrans.Models.Books", "Book")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BibTrans.Areas.Identity.Data.BibTransUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
